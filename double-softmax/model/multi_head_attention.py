...
class MultiheadAttention(Module):
    ...
    def forward(self,
        ...
        # (tgt_len,batch_size,word_emb_dim)
        ...
        scaling = float(head_dim) ** -0.5  # 缩放因子

        # 三个Q、K、V的全连接层，生成新的q，k，v
...
#        assert list(attn_output_weights.size()) == [batch_size * num_heads, tgt_len, src_len]
        ...
        # attn_output_weights = torch.softmax(attn_output_weights, dim=-1)  #进行softmax操作
        # print("矩阵attn_output_weights：")
